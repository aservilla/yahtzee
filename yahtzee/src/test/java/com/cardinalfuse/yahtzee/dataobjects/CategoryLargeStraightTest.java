...
public class CategoryLargeStraightTest extends TestCase {
	...
	public void testScore() {
		...
		CategoryLargeStraight category = new CategoryLargeStraight();
		category.setRoll(roll);
		assertEquals(20, category.calculateScore());
	}
